<%@ page import="com.codegym.casetemplate.model.Customer" %>
...
<head>
    ...
    <jsp:include page="/dashboard/layout/meta_head.jsp"></jsp:include>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <form class="form-horizontal col-6 offset-1" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            <label class="col-md-2 control-label">CreatAt</label>
                            <div class="col-md-10">
...
<jsp:include page="/dashboard/layout/js_footer.jsp">
